              ...
              <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4" style={{color: "white"}}>
                ...
                <div class="col">
                  ...
                  <img
                    ...
                    style={{ width: "200px", height: "150px" }}
                  ></img>{" "}
                  <h4 style={{ color: "white"}}>SMS Verification Using Twilio </h4>{" "}
                  <span>
                    <a
                      href="https://otp-log.herokuapp.com/"
                      alt="password"
                    >
                      <button
                        style={{ color: "white", backgroundColor: "purple" }}
                  ...
                  <span>
                    <a
                      href="https://github.com/ttmgs/Magdi_Tiea-OTP-Login"
                      alt="otp"
                    >
                      <button
                        style={{ color: "white", backgroundColor: "red" }}
                  ...
                  <p style={{ color: "white"}}> 
                  <strong style={{color: "black"}}>Technologies Used: </strong> EJS, Node.JS, Mongoose, Twililo SMS
                  & Express
