...
<div class="b-example-divider"></div>
    ...
    <div class="px-4 pt-5 my-5 text-center border-bottom" style={{color: "white"}}>
      ...
      <div class="col-lg-6 mx-auto">
        <p class="lead mb-4" style={{color: "white"}}> Focused and quick learning Full Stack Web Developer who enjoys computer science, programming, and UX design for various projects.</p>
